    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{route('pasangan.store')}}" enctype="multipart/form-data" method="POST" class="form form-vertical" >
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <select name="ketua_id" id="id" class="form-control" required="">
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <select name="wakil_id" class="form-control id" required="">
                                            <option value="">Pilih</option>
